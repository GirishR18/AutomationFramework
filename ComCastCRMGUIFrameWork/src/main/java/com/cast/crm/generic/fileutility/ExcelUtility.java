...
public class ExcelUtility {
	...
	public void getDataFromExcelFile(String sheetName, int rowNum, int celNum, String data) throws Throwable {
		FileInputStream fis = new FileInputStream("./testData/AdvanceSeleniumTestData.xlsx");
		Workbook wb = WorkbookFactory.create(fis);
	    Cell cel = wb.getSheet(sheetName).getRow(rowNum).createCell(celNum);
	    cel.setCellType(CellType.STRING);
	    cel.setCellValue(data);
	    FileOutputStream fos = new FileOutputStream("./testData/AdvanceSeleniumTestData.xlsx");
		wb.write(fos);
		wb.close();
